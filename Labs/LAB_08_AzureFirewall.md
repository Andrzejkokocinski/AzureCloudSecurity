...
6. On the **Custom deployment** blade, ensure that the following settings are configured (leave any others with their default values):
   ...
   |Resource group|click **Create new** and type the name **lab08LAB08**|
   |Location|**(US) East US**|
...
6. On the **Resource groups** blade, in the list of resource group, click the **lab08LAB08** entry.

    >**Note**: On the **lab08LAB08** resource group blade, review the list of resources. You can sort by **Type**.
...
1. In the Azure portal, navigate back to the **lab08LAB08** resource group.

2. On the **lab08LAB08** blade, in the list of resources, click the **Srv-Work** virtual machine.
...
2. On the **lab08LAB08** blade, in the list of resources, click the **Srv-Jump** virtual machine.
...
3. In the PowerShell session within the Cloud Shell pane, run the following to remove the resource group you created in this lab:
    ...
    ```powershell
    Remove-AzResourceGroup -Name "lab08LAB08" -Force -AsJob
    ```
