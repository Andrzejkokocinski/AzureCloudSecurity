...
4. On the **Basics** tab of the **Create virtual network** blade, specify the following settings (leave others with their default values) and click **Next: IP Addresses**:
    ...
    |Resource group|click **Create new** and type the name **lab12LAB12**|
...
6. On the **Resource groups** blade, in the list of resource group, click the **lab12LAB12** entry.

7. On the **lab12LAB12** resource group blade, in the list of resources, click the entry representing the newly created storage account.
...
3. In the PowerShell session within the Cloud Shell pane, run the following to remove the resource group you created in this lab:
    ...
    ```powershell
    Remove-AzResourceGroup -Name "lab12LAB12" -Force -AsJob
    ```
