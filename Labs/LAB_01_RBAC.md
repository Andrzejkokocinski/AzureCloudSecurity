...
2. On the **Resource groups** blade, click **+ Create** and specify the following settings:
   ...
   |Resource group name|**lab01Lab01**|
   |Location|**East US**|
...
1. On the **Resource groups** blade, click the **lab01LAB01** resource group entry.

2. On the **lab01Lab01** blade, click **Access control (IAM)** in the middle pane.

3. On the **lab01Lab01 \| Access control (IAM)** blade, click **+ Add** and then, in the drop-down menu, click **Add role assignment**.
...
7. On the **lab01Lab01 \| Access control (IAM)** blade, on the **Check access** tab, in the **Search by name or email address** text box, type **Dylan Williams**.

8. In the list of search results, select the user account of Dylan Williams and, on the **Dylan Williams assignments - lab01Lab01** blade, view the newly created assignment.

9. Close the **Dylan Williams assignments - lab01Lab01** blade.
...
3. In the PowerShell session within the Cloud Shell pane, run the following to remove the resource group you created in this lab:
    ...
    ```
    Remove-AzResourceGroup -Name "lab01LAB01" -Force -AsJob
    ```
